...
handling situations in which something goes wrong
* In many cases, Rust requires
...
errors
* For a recoverable error, such as a *file not found* error, we most
...
about returning `Result<T, E>` values
