...
of programs, but correctness is complex and not easy to prove
* Rust’s type
...
it
* This function’s signature accepts an integer as a parameter and returns an
integer as a result
* When we implement and compile that function, Rust does all
...
to this function
* But Rust *can’t* check that this function will do precisely
...
`add_two` function, the returned value is `5`
...
facilities
* We’ll talk about the annotations and macros available to you when
