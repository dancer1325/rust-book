* ALL programs have to manage the way / they use a computer’s memory | run
  * ways
    * -- via -- garbage collection
      * == | program runs, regularly looks for NO-longer-used memory
    * -- via -- MANUAL allocation & free memory
    * -- via -- [ownership](#what-is-ownership)
      * _Example:_ Rust approach

## What Is Ownership?

* *Ownership* 
  * == set of rules /
    * 💡govern how a Rust program manages memory💡
      * compiler checks
